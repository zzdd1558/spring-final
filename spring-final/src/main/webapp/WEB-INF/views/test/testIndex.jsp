...
<!-- //for-mobile-apps -->
<link href="stylesheets/test/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="stylesheets/test/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="stylesheets/test/fasthover.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script src="javascripts/test/jquery.min.js"></script>
<!-- //js -->
<!-- countdown -->
<link rel="stylesheet" href="stylesheets/test/jquery.countdown.css" />
<!-- //countdown -->
<!-- cart -->
<script src="javascripts/test/simpleCart.min.js"></script>
<!-- cart -->
<!-- for bootstrap working -->
<script type="text/javascript" src="javascripts/test/bootstrap-3.1.1.min.js"></script>
<!-- //for bootstrap working -->
				...
				<div class="modal-body modal-body-sub">
					<div class="row">
						<div class="col-md-8 modal_body_left modal_body_left1" style="border-right: 1px dotted #C2C2C2;padding-right:3em;">
							...
							<script src="javascripts/test/easyResponsiveTabs.js" type="text/javascript"></script>
							<script type="text/javascript">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="w3ls_products_pos">
											<h4>50%<i>Off/-</i></h4>
											<img src="images/test/1.jpg" alt=" " class="img-responsive" />
										</div>
									</div>
									<div class="clearfix"></div>
								</div>
		...
		<div class="footer-copy">
			<div class="footer-copy1">
				<div class="footer-copy-pos">
					<a href="#home1" class="scroll"><img src="images/test/arrow.png" alt=" " class="img-responsive" /></a>
				</div>
			</div>
			<div class="container">
