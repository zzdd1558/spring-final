...
<html>
<head>
<%@ include file="/WEB-INF/include/test/include-header.jspf"%>
</head>
<body>
	<!-- header -->
<%@ include file="/WEB-INF/include/test/include-bodyHeader.jspf"%>
	<!-- //header -->
<!-- banner -->
...
<!-- //newsletter -->
	<!-- footer -->
<%@ include file="/WEB-INF/include/test/include-footer.jspf"%>
	<!-- //footer -->
</body>
</html>