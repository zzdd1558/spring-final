	...
	<form id="joinForm">
		...
		<div class="w3-margin-left">
			<ul id="boxUl" class="w3-ul" style="padding-left: 1px">
				<li>
					<div class=" writeTitle">이름</div> <input type="text" name="userName"
					id="u_name" placeholder="이름" required> <span></span>
				</li>
				<li>
					<div class=" writeTitle">아이디</div> <input type="text" name="userId"
				...
				<li>
					...
					name="userPassword" id="u_password" placeholder="비밀번호"> <span
					style="font-size: 14px; color: gray"> 숫자 , 대·소문자 , 특수문자를 포함한
						8~16자리의 비밀번호 </span>
				</li>
				<li>
					<div class=" writeTitle" required>비밀번호 확인</div> <input
					type="password"  id="u_password_confirm"
				...
				<li>
					...
					<div class='writeBirth' id='writeBirth'>
						...
						<div class='birthText'>
							<input type="text" maxlength="1" name='userGender'
				...
				<li>
					...
					name="userPhone" id="u_phone_number"
					placeholder="하이픈(-) 제외한 숫자만입력가능" maxlength="11" required> <span></span>
				</li>
				<li>
					...
					placeholder=" 정확하게 입력해주세요 " required> <span></span>
				</li>

				<li>
					<div class=" writeTitle">이메일</div> <input type="text"
					name="userEmail" id="u_email" placeholder="이메일 주소" required>
					<span style="font-size: 14px; color: gray">회원 승인여부를 판단할 메일이
						전송되니 정확하게 입력해주세요.</span>
				</li>
				<li>
					<div class=" writeTitle">우편번호</div> <input type="text"
					name="u_address_total" id="u_address_zip_no" placeholder="우편번호 5자리"
					readonly="readonly" required> <input type="text"
					name="u_address_part" id="u_address_part" class="subAddr"
					placeholder="도로명 주소" readonly="readonly" required> <input
					type="text" name="u_address_detail" id="u_address_detail" class="subAddr"
				...
				<li>
					<div id="googleReCaptcha"></div> <span></span>
				</li>
