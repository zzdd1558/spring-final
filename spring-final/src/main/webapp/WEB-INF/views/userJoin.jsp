	...
	<div id="joinForm">
		...
		<div class="w3-margin-left">
			<ul id="boxUl" class="w3-ul"style="padding-left:1px">
				<li>
					<div class=" writeTitle">이름</div>
						<input type="text" name="u_name" id="u_name" placeholder="이름">
				</li>
				<li>
					<div class=" writeTitle">아이디</div>
				...
				<li>
					<div class=" writeTitle">비밀번호</div>
						<input type="text" name="u_password" id="u_password" placeholder="비밀번호"> <span style="font-size: 14px; color: gray"> 숫자 , 대·소문자 , 특수문자를
							포함한 8~16자리의 비밀번호 </span>
				</li>
				<li>
					<div class=" writeTitle">비밀번호 확인</div>
						<input type="text" name="u_password_confirm" id="u_password_confirm" placeholder="비밀번호 확인"> <span></span>
				</li>
				<li>
				...
				<li>
					<div class=" writeTitle">휴대폰번호</div>
						<input type="text" name="u_phone_number" id="u_phone_number" placeholder="하이픈(-) 제외한 숫자만입력가능" maxlength="11">
				</li>
				<li>
					<div class=" writeTitle">이메일</div>
						<input type="text" name="u_email" id="u_email" placeholder="이메일 주소"> <span></span>
				</li>
				<li>
					<div class=" writeTitle">우편번호</div>
						<input type="text" name="u_address" id="u_address_zip_no" placeholder="우편번호 5자리" readonly="readonly"> <input type="text" name="u_address" id="u_address_part" class="subAddr" placeholder="도로명 주소" readonly="readonly"> <input type="text" name="u_address" id="u_address_detail" class="subAddr" placeholder="상세 주소 "> <input type="hidden" name="u_address_full" id="u_address_full" value="">
		...
		<img src="/final/images/social/facebook_icon_color.png" alt="" class="snsShare" onclick="socialShareType.shareURL('facebook')"> <img src="/final/images/social/kakaoStory.png" alt="" class="snsShare" onclick="socialShareType.shareURL('kakao')">
		<img src="/final/images/social/naver_icon_green.png" alt="" class="snsShare" onclick="socialShareType.shareURL('naver')">
		<img src="/final/images/social/twitter_icon.png" alt="" class="snsShare" onclick="socialShareType.shareURL('twitter')">
