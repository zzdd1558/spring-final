...
<body>
	...
	<div class="banner-bottom">
		<div class="container">
			...
			<div class="col-md-5 wthree_banner_bottom_left">
				...
				<!-- pop-up-box -->
				<link
					href="${pageContext.request.contextPath}/stylesheets/popuo-box.css"
					rel="stylesheet" type="text/css" property="" media="all" />
				<script
					src="${pageContext.request.contextPath}/javascripts/jquery.magnific-popup.js"
		...
		<div class="container">
			...
			<div class="w3agile_special_deals_grids">
				<div class="col-md-7 w3agile_special_deals_grid_left">
					...
					<script
						src="${pageContext.request.contextPath}/javascripts/jquery.wmuSlider.js"></script>
					<script>
						$('.example1').wmuSlider();
					</script>
				</div>
	...
	<div class="top-brands">
		<div class="container">
			...
			<div class="sliderfig">
				<ul id="flexiselDemo1">
					<li><img src="images/test/4.png" alt=" "
						class="img-responsive" /></li>
					<li><img src="images/test/5.png" alt=" "
						class="img-responsive" /></li>
					<li><img src="images/test/6.png" alt=" "
						class="img-responsive" /></li>
					<li><img src="images/test/7.png" alt=" "
						class="img-responsive" /></li>
					<li><img src="images/test/46.jpg" alt=" "
						class="img-responsive" /></li>
				</ul>
			</div>
			<script type="text/javascript">
